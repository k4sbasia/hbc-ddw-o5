...
#############################################################################################################################
#####
#####   PROGRAM NAME : o5_edb_stage_cm_coa.sh
#####
#####   DESCRIPTION  : This script does the following
#####	             1.Stage CheetahMail Change Of Address
#####
#####
...
export CTL=$HOME/CTL
export PROCESS='o5_edb_stage_cm_coa'
...
export FILE_NAME="o5_coa_${YDAY}.dat"
...
";
  for f in $(head -n1 ${DATA}/${FILE_NAME} | edb_dos2unix | tr '[:upper:],' '[:lower:] '); do
    ...
    case ${f} in
      (email_to)     f="new_email_address";
                     v="char \"trim(upper(:${f}))\"";
                     ;;
      (email_from)   f="old_email_address";
                     v="char \"trim(upper(:${f}))\"";
                     ;;
      (date_changed) f="changed";

...
#############################################################################################################################
#####
#####   PROGRAM NAME : o5_edb_stage_store_emails.sh
#####
...
#####                                   ------------            ----------      ------------
#####                                   Sripriya Rao            03/26/2018      Created
#############################################################################################################################
################################################################
. $HOME/params.conf o5
export PROCESS='o5_edb_stage_store_emails'
export SQL=$HOME/SQL
export LOG=$HOME/LOG
...
export FILE_NAME="OFFFIFTH_EMAIL.${yesterday}"
export LOAD_COUNT='0'
export FILE_COUNT='0'
export TFILE_SIZE='0'
...
if [ ! -f ${DATA}/${FILE_NAME} ]
then
    echo "Today's file, ${FILE_NAME} is not found...Please check!!!" >> $LOG_FILE
    exit 99
fi

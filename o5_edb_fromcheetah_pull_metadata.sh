...
#############################################################################################################################
#####
#####   PROGRAM NAME : o5_edb_fromcheetah_pull_metadata.sh
#####
#####   DESCRIPTION  : Pulls the metadata file from cheetah
#####
#####
#####
####
...
export PROCESS='o5_edb_fromcheetah_pull_metadata'
export SQL=$HOME/SQL
export LOG=$HOME/LOG
...
export filename=o5_iid_keys_$YDAY.dat.gz.pgp
export filename2=o5_iid_keys_$YDAY.dat.gz
export filename3=o5_iid_keys_$YDAY.dat
################################################################
...
#################################################################
#################################################################
echo "Starting FTP pull process for metadata file " > ${LOG_FILE}
...
mv $DATA/$filename3  $DATA/o5_email_cheetah_metadata.dat


echo "Finished FTP pull process for metadata file\n " >> ${LOG_FILE}
#################################################################

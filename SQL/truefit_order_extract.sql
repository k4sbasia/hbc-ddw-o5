...
round(ord.line_total/  DECODE(ord.SHIPPED_QUANTITY,0,ord.status_quantity,ord.SHIPPED_QUANTITY) ,2) ||'"|"'||'USD' ||'"|"'|| sku_atr.SKU_SIZE_DESC ||'"|"'|| ' ' ||'"|"'|| 'en_US' ||'"'||'"|"'||DECODE(prd_atr.ITEM_GENDER, 1,'Not Applicable', 2,'Men', 3,'Women', 4,'Unisex', 5,'Kids' ,6,'Pets', NULL) gender

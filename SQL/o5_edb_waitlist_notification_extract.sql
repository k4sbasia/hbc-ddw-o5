...
USING (SELECT TIME_SENT, SKU_CODE_LOWER,EMAIL,SUM(QTY_PURCHASED)QTY_PURCHASED,MIN(ORDER_NUMBER)ORDER_NUMBER,MIN(ORDER_DATE)ORDER_DATE FROM o5.tmp_edb_waitlist_extract_src1 GROUP BY SKU_CODE_LOWER,EMAIL, TIME_SENT) T2

...
ALTER TABLE O5.INVENTORY ADD (MODIFY_DT DATE);

ALTER TABLE O5.INVENTORY ADD (INSTOCK_DT DATE);

ALTER TABLE  O5.INVENTORY_STORES ADD (MODIFY_DT DATE,INSTOCK_DT DATE);
...
where bpw.sku=sfw.PRODUCT_SKUS   ;
      commit;
...
ALTER TABLE O5.WAITLIST ADD (WAITLIST_RCVD_SDW_DT DATE DEFAULT SYSDATE);


ALTER TABLE O5.bi_customer_wrk ADD (recency_date_time DATE);

ALTER TABLE O5.bi_customer ADD (recency_date_time DATE);



  CREATE TABLE "O5"."CSR_ECHO_SURVEY_FEED_DATA"
   (	"ORDER_NO" VARCHAR2(30 BYTE),
	"ENTERPRISE_KEY" VARCHAR2(15 BYTE),
	"ORDER_DATE" DATE,
	"EMAILID" VARCHAR2(500 BYTE),
	"CREATEUSERID" VARCHAR2(30 BYTE),
	"USERNAME" VARCHAR2(50 BYTE),
	"CONTACT_TIME" VARCHAR2(100 BYTE),
	"ENTRY_TYPE" VARCHAR2(100 BYTE),
	"EXTN_COMMUNICATION_LANG" VARCHAR2(100 BYTE)
);
